<template>
  <div class="home">
    ...
    <navigation/>
    <div class="content">
      <h1 class="headingText"><span class="colored">Cosmo</span> Journey</h1>
...
.content{
  width: 100%;
  background: #030416 url('../assets/background.jpg') center no-repeat;
...
.input{
  ...
  &:focus{
    box-shadow: 0 0 12px 2px #397fc0;
  }
}
.submit{
  width: 40px;
